...
`;a.s(["getCloudflareContext",0,function(a={async:!1}){return a.async?d():function(){let a,b=c();if(b)return b;if(a=globalThis,a.__NEXT_DATA__?.nextExport===!0)throw Error("  - make sure that the call is not at the top level and that the route is not static\n  - call `getCloudflareContext({async: true})` to use the `async` mode\n  - avoid calling `getCloudflareContext` in the route\n");throw Error(f)}()}])},10585,a=>{a.v("/_next/static/media/favicon.2vob68tjqpejf.ico"+(globalThis.NEXT_CLIENT_ASSET_SUFFIX||""))},68611,a=>{"use strict";let b={src:a.i(10585).default,width:256,height:256};a.s(["default",0,b])},57583,a=>{"use strict";var b=a.i(7997),c=a.i(95936);a.i(70396);var d=a.i(73727),e=a.i(2424),f=a.i(27338);async function g(a){let{env:b}=await (0,e.getCloudflareContext)(),c=b.DB,d=await c.prepare(`
      ...
      WHERE area_id = ?
      ORDER BY name ASC
      `).bind(a).all();return{area:d,zones:f}}async function h({params:a}){let{id:e}=await a,i=await g(e);i||(0,d.notFound)();let{area:j,zones:k}=i;return(0,b.jsxs)(f.AppShell,{children:[(0,b.jsx)(c.default,{href:"/areas",className:"mb-8 inline-block text-sm text-zinc-500 transition hover:text-white",children:"← Back to areas"}),(0,b.jsxs)("div",{className:"mb-12",children:[(0,b.jsx)("p",{className:"mb-3 text-xs uppercase tracking-[0.4em] text-zinc-600",children:j.country_name??"Unknown"}),(0,b.jsx)("h1",{className:"text-5xl font-bold",children:j.name}),(0,b.jsx)("p",{className:"mt-4 max-w-2xl text-zinc-400",children:j.description??"No description yet."})]}),(0,b.jsxs)("section",{children:[(0,b.jsx)("h2",{className:"mb-6 text-3xl font-bold",children:"Zones"}),0===k.length?(0,b.jsx)("div",{className:"rounded-3xl border border-zinc-800 p-8 text-zinc-400",children:"No zones added yet."}):(0,b.jsx)("div",{className:"grid gap-6 md:grid-cols-2",children:k.map(a=>(0,b.jsxs)(c.default,{href:`/zones/${a.id}`,className:"block rounded-3xl border border-zinc-800 p-6 transition hover:border-zinc-600",children:[(0,b.jsx)("h3",{className:"text-2xl font-bold",children:a.name}),(0,b.jsx)("p",{className:"mt-3 text-sm text-zinc-500",children:"View routes in this zone →"})]},a.public_id))})]})]})}a.s(["default",0,h,"dynamic",0,"force-dynamic"])},23600,a=>{a.n(a.i(57583))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0ecv3kw._.js.map